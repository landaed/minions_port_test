...
if USE_WX:
    from mud.worlddaemon.gui import Setup
    app = Setup(reactor)
    reactor.registerWxApp(app)

from mud.gamesettings import *
from mud.worlddaemon.charservices import \
    StartServices as startCharacterServices,CServerAvatar
from mud.worlddaemon.gmservices import GMServices
from mud.worlddaemon.telnetmanhole import MakeFactory
from mud.worlddaemon.worldimp import StartServices as startImpServices
from mud.worlddaemon.worldservices import \
