...
RPG_AUCTION_SEARCH_REFRESH = 60*1 #1 minute - Auction House DB Refresh for the client.  Do not set below 15 seconds without some changes
RPG_MAIL_REFRESH = 60*1 #1 minute - Mail Refresh
RPG_AUCTION_BIDCOST = 1.25 #25% increase per bid
...
RPG_ITEM_QUEST = 1 << 9
# Rarity flags for the auction and other uses.  Does not exactly match up to the pop flags listed below and should be set on the item proto
RPG_ITEM_COMMON = 1 << 10 # White
RPG_ITEM_UNCOMMON = 1 << 11 # Green
RPG_ITEM_RARE = 1 << 12 # Blue
RPG_ITEM_ULTRARARE = 1 << 13 # Purple
...
RPG_SLOT_AUCTION = 178 # Auction Selling Slot
...
RPG_SPAWN_AUCTIONEER = 1 << 11 #Auction mob
...
RPG_AUCTION_LIGHT = 1
RPG_AUCTION_DARKNESS = 2
RPG_AUCTION_MULTI = 3

RPG_AUCTION_DBNAME = {
    RPG_AUCTION_LIGHT: "auctionList_light.db",
    RPG_AUCTION_DARKNESS: "auctionList_darkness.db",
    RPG_AUCTION_MULTI: "auctionList_multi.db"
}
