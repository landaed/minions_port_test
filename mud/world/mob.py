...
class Mob:
    ...
    def __init__(self,spawn,zone,player=None,char=None,master=None,sizemod=1.0):
        ...
        self.damageTimer = 0 # Used to force a NPC to chase outside of the follow range if it was damaged recently 
    ...
    def tick(self):
        ...
        # Handle non-player mobs.
            ...
            #If the timer is set the NPC will give chase outside of the Follow Radius.  Prevents "sniping". 
            if self.damageTimer: 
                self.damageTimer-=3 
