...
class Player(Persistent):    
    ...
    auctionLast = DateTimeCol(default = datetime(2000,1,1))
...
#money
    ...
    def updateTracking(self):
        ...
        for otherMob in self.zone.activeMobs:
            ...
            # Immortals don't show up on tracking or map.    
            if otherMob.player and otherMob.player.role.name == "Immortal":
                continue
                
            # Guardians don't show up on tracking or map.    
            if otherMob.player and otherMob.player.role.name == "Guardian":
                continue 
