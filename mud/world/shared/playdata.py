...
class ItemInfo(pb.Cacheable):
    ...
    def getFullState(self):
        ...
        #Changed for Auction Item
        if item.itemProto:
            state['PROTOID'] = item.itemProto.id
        else:
            state['PROTOID'] = item.auctionItemID
...
class CharacterInfo(pb.Cacheable):
    ...
    def getStateToCacheAndObserveFor(self, perspective, observer):
        ...
        #auction
        state['AUCTIONID'] = character.auctionIDN        
    ...
    def refreshLite(self,send=False):
        ...
        #Auction
        if state['AUCTIONID'] != character.auctionIDN:
            changed['AUCTIONID'] = state['AUCTIONID'] = character.auctionIDN        
