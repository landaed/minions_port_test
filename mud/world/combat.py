...
class CombatProcess(Process):
    ...
    def doAttack(self, dmg, offhand=False):
        ...
        attacker.zone.simAvatar.mind.callRemote("playAnimation",attacker.simObject.id,"_attack") 
        ...
        if block and defender.plevel+5>=attacker.plevel:
            ...
            if randint(0,x) < block:
                ...
                #Floating Text
                msg = "Block"           # just print a number for now
                color = (255,255,0)     # Yellow
                color2 = (255,255,255)  # White
                if attacker and attacker.player and attacker.player.mind:
                    defender.zone.simAvatar.mind.callRemote("showDamage", defender.simObject.id, msg, color2 )
                if defender and defender.player and defender.player.mind:
                    defender.zone.simAvatar.mind.callRemote("showDamage", defender.simObject.id, msg, color )
        ...
        if block and defender.plevel+5>=attacker.plevel:
            ...
            if randint(0,x) < block:
                ...
                #Floating Text
                msg = "Dodge"           # just print a number for now
                color = (255,255,0)     # Yellow
                color2 = (255,255,255)  # White
                if attacker and attacker.player and attacker.player.mind:
                    defender.zone.simAvatar.mind.callRemote("showDamage", defender.simObject.id, msg, color2 )
            ...
            if not skip:
                ...
                if block and defender.plevel+5>=attacker.plevel:
                    ...
                    if randint(0,x) < block:
                        ...
                        #Floating Text
                        msg = "Shield Block"           # just print a number for now
                        color = (255,255,0)     # Yellow
                        color2 = (255,255,255)  # White
                        if attacker and attacker.player and attacker.player.mind:
                            defender.zone.simAvatar.mind.callRemote("showDamage", defender.simObject.id, msg, color2 )
