# Embedded file name: mud\world\inn.pyo
...
class Inn(pb.Root):
    ...
    def remote_addToParty(self, cname):
        if not self.player:
            ...
            if AVATAR:
                ...
                d = AVATAR.mind.callRemote('getCharacterBuffer', player.publicName, cname)
            ...
            if c.player != player:
                print "WARNING: Player at inn attempting to add a character that isn't theirs!"
                return
            ...
            if player.realm == RPG_REALM_MONSTER:
                ...
                player.sendGameText(RPG_MSG_GAME_EVENT, "Rawr! Monsters don't like to party.\\n")
    ...
    def sendLists(self):
        ...
        self.innWnd.callRemote('setInn', cinfos, pinfos)
