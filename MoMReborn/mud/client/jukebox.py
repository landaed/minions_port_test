# Embedded file name: mud\client\jukebox.pyo
...
import random
FULL_MUSIC = ['01 - Welcome_Sign.ogg',
...
def PySongStopped():
    ...
    if not MUSICDEFFERED:
        MUSICDEFFERED = reactor.callLater(10, PlayMusic)
...
def PlaySong(song):
    ...
    eval = 'alxPlay(alxCreateSource(AudioMusic, "%s"));' % filename
    TGEEval(eval)
    return
