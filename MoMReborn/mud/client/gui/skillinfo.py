# Embedded file name: mud\client\gui\skillinfo.pyo
...
SKILLINFOS['Waylay'] = SkillInfo('Waylay', False, 'SPELLICON_1_5')
SKILLINFOS['Endurance'] = SkillInfo('Endurance', False, 'SPELLICON_1_6')
SKILLINFOS['Dispersion'] = SkillInfo('Dispersion', False, 'SPELLICON_5_22')
SKILLINFOS['Sanctify'] = SkillInfo('Sanctify', False, 'SPELLICON_3_24')
